...
public class RoleController {
    ...
    public PageResultBean<WebScRole> getList(@RequestParam(value = "page", defaultValue = "1") int page,
                                        ...
                                        WebScRole roleQuery) {
        List<WebScRole> roles = roleService.selectAll(page, limit, roleQuery);
        PageInfo<WebScRole> rolePageInfo = new PageInfo<>(roles);
    ...
    @PostMapping
    @ResponseBody
    public ResultBean add(WebScRole role) {
    ...
    public String update(@PathVariable("roleId") Integer roleId, Model model) {
        WebScRole role = roleService.selectOne(roleId);
    ...
    @PutMapping
    @ResponseBody
    public ResultBean update(WebScRole role) {
