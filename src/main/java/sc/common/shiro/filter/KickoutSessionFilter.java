package sc.common.shiro.filter;
...
import sc.common.constants.IStatusMessage;
import sc.common.util.ResultBean;
import sc.common.util.WebHelper;
	...
	protected boolean onAccessDenied(ServletRequest request, ServletResponse response) throws Exception {
		...
		if (!subject.isAuthenticated() && !subject.isRemembered()) {
			...
			if (WebHelper.isAjaxRequest(request)) {
				...
				resultBean.setCode(IStatusMessage.SystemStatus.MANY_LOGINS.getCode());
				resultBean.setMsg("您已在别处登录，请您修改密码或重新登录");
